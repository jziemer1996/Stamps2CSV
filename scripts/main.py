...
def main():
    ...
    stamps_csv = "Moehne_asc_final_stamps_export_coh_var_disp_ts.csv"
    output_csv = "Moehne_Asc_PS_points_ts_R.csv"

    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    # Executable function
    ascending.columns(working_dir, output_dir, stamps_csv, output_csv)
